...
\begin{document}
    ...
    \section{Objective}
    \begin{onecolentry}
        I am a personable and motivated professional with a strong record in communication, problem-solving, and event coordination. I seek a customer service role where I can leverage my skills to effectively resolve issues, and provide a positive, supportive experience.
    \end{onecolentry}
